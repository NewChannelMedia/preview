            ...
            <form class="sign-in-up-form" action="./loginMedicos.php" role="form" method="post" onsubmit="return false;">
              <div class="col-lg-10 col-md-10 col-sm-12 col-xs-12 col-lg-offset-1 col-md-offset-1">
                <div class="row">
                  ...
                  <div class="form-group col-lg-6 col-md-6 col-sm-6 col-xs-12">
                    <input class="form-control input-lg" id="estado" type="text" placeholder="Estado" autocomplete="off">
                  </div>
                  <div class="form-group col-lg-6 col-md-6 col-sm-6 col-xs-12">
                    <input class="form-control input-lg" id="ciudad" type="text" placeholder="Ciudad" autocomplete="off">
                  </div>
                  <div class="form-group col-lg-6 col-md-6 col-sm-6 col-xs-12">
                    <input class="form-control input-lg" id="especialidad" type="text" placeholder="Especialidad" autocomplete="off">
                  </div>
                  <div class="form-group col-lg-6 col-md-6 col-sm-6 col-xs-12">
                    <input class="form-control input-lg" id="subespecialidad" type="text" placeholder="SubEspecialidad" autocomplete="off">
                  </div>
                </div>
              </div>
              <div class="col-lg-6 col-md-6 col-sm-10 col-xs-10 col-lg-offset-3 col-md-offset-3 col-sm-offset-1 col-xs-offset-1">
